<template>
    <aside id="default-sidebar" class="W h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidenav">
        <div class="overflow-y-auto px-3 h-ful">
            <!-- header -->
            <div class="relative flex py-2 items-center font-medium opacity-45">
                <div class="flex-grow border-t border-white"></div>
                <span class="flex-shrink mx-4 text-white">NAVIGATE</span>
                <div class="flex-grow border-t border-white"></div>
            </div>
            <ul class="space-y-2">
                <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-tours" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#/tours"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Upcoming Tournaments</a>
                        </li>
                        <li>
                            <a href="#/tours"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Last Tournaments</a>
                        </li>
                        <li>
                            <a href="#/tours"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Most waiting Tournaments
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="dropdown-teams" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#/teams"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Teams list</a>
                        </li>
                        <li>
                            <a href="#/teams"
                ...
                <li>
                    ...
                    <ul id="dropdown-players" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#/players"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Players list</a>
                        </li>
                        <li>
                            <a href="#/players"
                                class="flex items-center p-2 pl-11 w-full text-sm font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100  ">Compare</a>
