<template>
    ...
    <div id="drawer-navigation"
        ...
        <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400">Меню
        </h5>
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="#/matches"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Players</span>
                    </a>
                </li>
            ...
            <div id="dropdown-cta" class="p-4 mt-6 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
                <div class="flex items-center mb-3">
                    <span
                        class="bg-orange-100 text-orange-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900">Реклама</span>
                    <button type="button"
